...
<body >
    ...
    <div class="container">
        <h2 class="text-center">Active polls to edit</h2><hr>
            <?php
            ...
            foreach($polls as $poll){
                ...
                if (!$expired){
                    echo '<form method="POST" action="edit.php" class="mb-3">';
                    ...
                    echo '<button type="submit" class="btn btn-primary mt-1">Edit</button>';
                    echo '</form>';
                    echo '<hr>';
                }
            }
