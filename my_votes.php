...
<body >
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link" href="#">My votes</a>
                </li>
                <?php 
    ...
    <div class="container">
            <h2 class="text-center">My votes</h2>
            <?php
            ...
            foreach($polls as $poll){
                ...
                if (array_key_exists($_SESSION['user'], $poll['voted']) && !$expired){
                    ...
                    echo '<form method="POST" action="my_votes.php">
                        <input type="hidden" name="id" value="'. $poll['id'] .'">
            ...
            echo '<h2 class="text-center">My expired votes</h2>';
            foreach($polls as $poll){
                $expired = time() > strtotime($poll['deadline']);
                if (array_key_exists($_SESSION['user'], $poll['voted']) && $expired){
                    echo "<h5>" . $poll['question'] . "</h5>";
                    ...
                    echo '<p class="text-danger"> Deadline has expired on ' . date('jS M Y', strtotime($poll['deadline'])) . '.</p>';
                    echo '<ul>';
